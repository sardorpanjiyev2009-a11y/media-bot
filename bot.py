...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "✍️ Shunchaki **qo'shiq nomini** yozib yuboring — 10 ta variant va yuklash tugmalarini chiqarib beraman!"
    )
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text.startswith("http"):
        ...
        try:
            ...
            # Videodan audio ajratib olamiz (API orqali qidirish uchun nom yoki vaqtinchalik)
            song_query = "Musiqa"
            
            # Xotirada so'rovni saqlaymiz
